...
class Beecolor_Elementor_Addon_Info_Box extends Widget_Base {
	...
	public function get_name(): string {
		return 'beecolor-info-box';
	}

	public function get_title(): string {
		return esc_html__( 'Info box', 'beecolor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'img_type',
			[
				'label' => esc_html__('Infobox Type', 'beecolor'),
				'type' => Controls_Manager::SELECT,
				'default' => 'img-on-top',
				'label_block' => false,
				'options' => [
					'img-on-top' => esc_html__('Image/Icon On Top', 'beecolor'),
					'img-on-left' => esc_html__('Image/Icon On Left', 'beecolor'),
					'img-on-right' => esc_html__('Image/Icon On Right', 'beecolor'),
				],
			]
		);
		...
		$this->add_control(
			'img_or_icon',
			[
				'label' => esc_html__('Image or Icon', 'beecolor'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'none' => [
						'title' => esc_html__('None', 'beecolor'),
						'icon' => 'fa fa-ban',
					],
					
					'icon' => [
						'title' => esc_html__('Icon', 'beecolor'),
						'icon' => 'fa fa-info-circle',
					],
					
					'img' => [
						'title' => esc_html__('Image', 'beecolor'),
		...
		$this->add_control(
			...
			[
				'label' => esc_html__('Icon Position', 'beecolor'),
				'type' => Controls_Manager::CHOOSE,
				'default' => 'top',
				'condition' => [
					'img_type!' => 'img-on-top',
		...
		$this->add_control(
			'selected_image',
			[
				'label' => esc_html__('Infobox Image', 'beecolor'),
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'default' => esc_html__('This is an icon box', 'beecolor'),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'label_block' => true,
				'rows' => 10,
				'default' => esc_html__('Write a short description, that will describe the title or something informational and useful.', 'beecolor'),
		...
		$this->add_control(
			'show_description',
			[
				'label' => esc_html__('Show Description', 'beecolor'),
		...
		$this->add_responsive_control(
			'content_alignment',
			[
				'label' => esc_html__('Content Alignment', 'beecolor'),
				'type' => Controls_Manager::CHOOSE,
				'label_block' => true,
				'options' => [
					'left' => [
		...
		$this->add_responsive_control(
			'icon_size',
			[
				'label' => esc_html__('Icon Size', 'beecolor'),
		...
		$this->start_controls_tab(
			'icon_normal',
			[
				'label' => esc_html__('Normal', 'beecolor'),
			]
		);
		...
		$this->add_control(
			'icon_color',
			[
				'label' => esc_html__('Icon Color', 'beecolor'),
		...
		$this->start_controls_tab(
			'icon_hover',
			[
				'label' => esc_html__('Hover', 'beecolor'),
			]
		);
        ...
        <div <?php echo $this->get_render_attribute_string('infobox_inner'); ?>>
            ...
            <div class="element-info-box__content">
                ...
                <?php if ( $settings['show_description'] == 'yes' ) : ?>
                    ...
                    <div class="text">
                        <?php echo wpautop( $settings['text'] ); ?>
                    </div>
