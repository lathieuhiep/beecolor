...
class beecolor_widget_post_carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'beecolor-post-carousel';
    }

    public function get_title() {
        return esc_html__( 'Posts Carousel', 'beecolor' );
    }
...
Plugin::instance()->widgets_manager->register_widget_type( new beecolor_widget_post_carousel );